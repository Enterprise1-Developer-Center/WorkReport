...
import kr.co.e1.workreport.projmanage.frag_emp.fd_emp_add.di.AddEmpDialogProvider;
import kr.co.e1.workreport.projmanage.frag_emp.fd_emp_edit.di.EditEmpDialogProvider;
...
@Subcomponent(modules = {
    ...
    AddProjDialogProvider.class, EditProjDialogProvider.class, AddEmpDialogProvider.class,
    EditEmpDialogProvider.class
